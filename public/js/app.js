...
function initAdmin() {
  ...
  axios__WEBPACK_IMPORTED_MODULE_1__["default"].get('/admin/orders', {
    ...
    var orders = res.data;
    var markup = generateMarkup(orders);
  ...
  function addEventListeners() {
    ...
    var forms = document.querySelectorAll('[id^="statusForm_"]');
          ...
          return _regeneratorRuntime().wrap(function _callee$(_context) {
            while (1) switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.prev = 2;
                _context.next = 5;
                return axios__WEBPACK_IMPORTED_MODULE_1__["default"].post('/admin/order/status', formData);
              case 5:
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkGocourier"] = self["webpackChunkGocourier"] || [];
